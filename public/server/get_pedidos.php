<?php
    ...
    echo '<button onclick="atualizarTabela()" id="atualizar">Atualizar Nota</button>';
    echo '<button onclick="imprimir()" id="imprimir">Imprimir Nota</button>';
?>  
<style>
    #atualizar{
    width: 145px;
...
<script>
    ...
    function imprimir(){
        alert('Nota do Pedido Foi Para Cozinha');
    }
</script>
